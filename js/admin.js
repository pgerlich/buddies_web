...
angular.module("myApp").controller("mainCtrl", function($scope, $uibModal){
    ...
    $scope.openEmployeeModal = function () {
        ...
        modalInstance.result.then(function (employeeInfo) {
            ...
            $.get( "php/createEmployee.php?EMAIL=" + employeeInfo.email, function( data ) {
                ...
                user.signUp(null, {
                    success: function(user) {
                        ...
                        $.get( "php/addEmployeeInformation" +
    ...
    $scope.saveBankAcc = function(status, response){
        ...
        if ( response.error ) {
            ...
            $.get( "php/addBankToEmployee.php?ACCID=" + $scope.tempEmployeeId + "&TOKEN=" + response.id, function( data ) {
